...
import { newWorksheetDoc, addWorksheetPage, uploadWorksheetPdf, shuffle, randInt, PAGE_W, PAGE_H, INK, NAVY, LINE } from '@/lib/worksheet-pdf';
...
export async function POST(request: NextRequest) {
  try {
    ...
    let page = addWorksheetPage(doc, helvBold, helv, docTitle, 'Fill in the missing letters. Use the word bank if you need help.');
    let y = PAGE_H - 140;
