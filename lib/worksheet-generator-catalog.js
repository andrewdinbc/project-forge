...
export const GENERATOR_CATALOG = [
  {
    ...
    tools: [
      ...
      { key: 'cipher-wheels', label: 'Cipher Wheels: Secret Code Facts', desc: 'A real cut-out rotating cipher disk (two concentric letter rings, assemble with a paper fastener) plus facts encoded with the same shift to decode.', href: '/dashboard/worksheet-generators/cipher-wheels', status: 'live' },
      ...
      { key: 'hidden-pictures', label: 'Hidden Picture Puzzles', desc: 'Find objects camouflaged in a themed vector scene -- every hidden object\'s exact position is tracked in code (not AI-generated), so the answer key is always accurate.', href: '/dashboard/worksheet-generators/hidden-pictures', status: 'live' },
      ...
      { key: 'word-maze', label: 'Word-Maze Puzzles', desc: 'A real recursive-backtracker maze -- letters along the one true path from start to end spell out a secret fact.', href: '/dashboard/worksheet-generators/word-maze', status: 'live' },
  ...
  {
    // Added 2026-07-20 (Aj: "pick the topic, it will pull up the schema,
    // input or create relevant art, use some of my pre made borders,
    // illustrations, etc, and encode the content in this way using all
    // of the parts together"). Follows Schema Lab schema
    // 373eb4ea-72e2-45ea-b444-a533c7c030b0 (Reading Comprehension Packet)
    // and, for the differentiated mode, 667e6e22-4c65-45e7-8507-19d0d26991db
    // (Differentiated Reading Passage, Lexile-Leveled). Leveling is
    // grounded against the real, professionally-leveled HELPS Curriculum
    // (helps_reference_passages, 100 passages) rather than an AI-guessed
    // Lexile number -- every passage is independently re-scored with
    // lib/readability.js so a grade mismatch is visible, not silent.
    group: 'Reading Passages', icon: '📖',
    tools: [
      { key: 'reading-passage', label: 'Reading Passage Generator', desc: 'Pick any topic and grade level -- get an original passage calibrated against the real HELPS Curriculum, an annotation guide, comprehension questions, and an answer key. Single-grade or 3-tier differentiated. Add your own border/header art from the Parts Library and an illustration.', href: '/dashboard/worksheet-generators/reading-passage', status: 'live' },
    ],
  },
  {
  ...
  },
  {
    ...
    tools: [
      ...
      { key: 'task-cards', label: 'Task Cards', desc: 'A cut-apart set of question/task cards from any topic, AI-generated with an answer key -- for stations, SCOOT games, or task rotations.', href: '/dashboard/worksheet-generators/task-cards', status: 'live' },
      { key: 'choice-board', label: 'Choice Board', desc: 'A 3x3 or 4x4 grid of varied activities on any topic -- students pick which ones to complete, not the whole set.', href: '/dashboard/worksheet-generators/choice-board', status: 'live' },
    ],
  },
  {
