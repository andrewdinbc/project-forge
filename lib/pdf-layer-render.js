...
// Same class of bug, same fix (2026-07-20): pdf.js's canvas backend also
// reaches for a global Path2D on pages with certain vector path constructs
// (hit analyzing a real lapbook PDF via Schema Lab's analyze-structure --
// 'Path2D is not defined' at render time, identical failure shape to the
// DOMMatrix case above just a different missing global). @napi-rs/canvas
// ships a real Path2D implementation; same wiring fix applies.
