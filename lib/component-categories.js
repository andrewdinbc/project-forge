...
export const CATEGORY_GROUPS = [
  ...
  },
  {
    ...
    icon: '🎨',
    categories: [
      { key: 'clean_fonts', label: 'Change Fonts', description: 'Swap in a page representing different, readable, age-appropriate typography.' },
      { key: 'borders_layout', label: 'Change Borders and Layout', description: 'Swap in a page representing different borders or spacing/layout treatment.' },
