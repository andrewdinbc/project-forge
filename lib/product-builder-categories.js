...
export const STYLE_CATEGORIES = [
  ...
  },
  {
    ...
    hint: 'A saved set of colors pulled from a resource.',
    editorLabel: 'Style Editor', editorPath: '/dashboard/asset-modifier', multi: false,
  },
]
...
export function emptySelections() {
  return { border: null, section_header: null, font: null, spacing_alignment: null, icon_illustration: [], color_palette: null }
}
