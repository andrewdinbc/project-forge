...
export const COMIC_CAST_CATALOG: { id: string; name: string; type: 'mascot' | 'student' | 'brand_mascot' | 'adult' | 'pet' | 'teen' | 'folklore'; description: string; poses: string[] }[] = [
  ...
  { id: 'takeshi', name: 'Takeshi', type: 'folklore', description: 'a young samurai warrior in traditional armor -- energetic, brave, heroic-adventure energy, good for storytelling/mythology/world cultures/Japanese-history topics', poses: ['base', 'happy', 'thinking', 'pointing'] },
